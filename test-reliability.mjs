...
assert.match(configRoom.applyAction(rollPermissionState,{role:'host',teamId:null},'allowRoll',{teamId:0,diceCount:6}).error,/1～5/);
assert.equal(configRoom.applyAction(rollPermissionState,{role:'host',teamId:null},'allowRoll',{teamId:0,diceCount:2}),undefined);
...
assert.deepEqual(rollPermissionState.rollDiceCounts,{0:2,1:4});

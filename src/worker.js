...
const APP_BUILD_VERSION = '2026.08.19.9';
...
function configRange(path){ if(CONFIG_RANGES[path])return CONFIG_RANGES[path];return /^levels\.\d+\.(stay|up|sell)$/.test(path)?[0,1000000]:null; }

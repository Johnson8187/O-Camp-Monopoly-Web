...
function resetGameFx(){Object.values(App.fx.timers).forEach(clearTimeout);App.fx={phase:null,event:null,attack:null,aftershock:null,dice:null,camera:null,positions:{},timers:{},stepText:''};App.highlight=[];}
